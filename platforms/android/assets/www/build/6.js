...
var FoodCategoryItemsPage = (function () {
    function FoodCategoryItemsPage(navCtrl, navParams, viewCtrl, http, modalCtrl) {
    ...
    FoodCategoryItemsPage.prototype.getFoodItems = function () {
        ...
        this.http.get('assets/i18n/en.json').subscribe(function (data) {
            _this.foodItems = data.FOOD_ITEMS[_this.categoryName];
        }, function (error) {
     ...
     * --------------------------------------------------------------
     */
    FoodCategoryItemsPage.prototype.gotoItemDetails = function () {
